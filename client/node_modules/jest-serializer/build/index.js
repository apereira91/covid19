...
function deserialize(buffer) {
  ...
  return (_v || _load_v()).default.deserialize
    ? (_v || _load_v()).default.deserialize(buffer)
=======
} // In memory functions.
...
<<<<<<< HEAD
  // $FlowFixMe - Node 8+ only
  return (_v || _load_v()).default.serialize
    ? (_v || _load_v()).default.serialize(content)
...
function readFileSync(filePath) {
  // $FlowFixMe - Node 8+ only
  return (_v || _load_v()).default.deserialize
    ? (_v || _load_v()).default.deserialize(
        (_fs || _load_fs()).default.readFileSync(filePath)
      )
    : jsonParse((_fs || _load_fs()).default.readFileSync(filePath, 'utf8'));
}
